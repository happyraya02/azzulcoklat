            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>Produk Frozen Food</h2>
                    </div>
                    <div class="featured__controls">
                        <ul>
                            <li class="active" data-filter="*">All</li>
                            <li data-filter=".oranges">Kebab Daging Sayur</li>
                            <li data-filter=".fresh-meat">Cireng salju</li>
                            <li data-filter=".vegetables">Steak Daging Sapi</li>
                            <li data-filter=".fastfood">Pempek Palembang</li>
                            <li data-filter=".oranges">Tekwan Palembang</li>
                            <li data-filter=".fresh-meat">Ayam Bakar</li>
                            <li data-filter=".vegetables">Ayam Serundeng</li>
                            <li data-filter=".fastfood">Baso Tasik</li>
                            <li data-filter=".oranges">Otak" Bulat</li>
                            <li data-filter=".fresh-meat">Otak" Panjang</li>
                            <li data-filter=".vegetables">Siomay</li>
                            <li data-filter=".fastfood">Kekkian</li>
                            <li data-filter=".oranges">Dimsum</li>
                            <li data-filter=".fresh-meat">Donat Kentang</li>
                            <li data-filter=".vegetables">Roti Maryam</li>
                            <li data-filter=".fastfood">Kaki Naga Udang</li>
                            <li data-filter=".oranges">Tahu Baso Daging</li>
                            <li data-filter=".fresh-meat">Sate Lilit Ayam</li>
                        </ul>
                    </div>
                </div>
            </div>
