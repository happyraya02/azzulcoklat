                ...
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            <li data-filter=".oranges">Chiki Ball</li>
                            <li data-filter=".fresh-meat">Jetz Coklat</li>
                            <li data-filter=".vegetables">Jetz Hollow</li>
                            <li data-filter=".fastfood">Cheetos</li>
                            <li data-filter=".fresh-meat">Chitato</li>
                            <li data-filter=".vegetables">Pillow</li>
                            <li data-filter=".fastfood">Egg Drop</li>
                            <li data-filter=".oranges">Taro</li>
                            <li data-filter=".fresh-meat">Piatos</li>
                            <li data-filter=".fastfood">Ring</li>
                            <li data-filter=".oranges">Rin Bee</li>
                            <li data-filter=".fresh-meat">Nabati</li>
                            <li data-filter=".vegetables">Kwaci</li>
                            <li data-filter=".fastfood">Lays</li>
                        </ul>
                    </div>
                </div>
            </div>
