            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>Produk Marsmallow</h2>
                    </div>
                    <div class="featured__controls">
                        <ul>
                            <li class="active" data-filter="*">All</li>
                            <li data-filter=".oranges">Silverqueen</li>
                            <li data-filter=".fresh-meat">Delfie</li>
                            <li data-filter=".vegetables">Scandia</li>
                            <li data-filter=".fastfood">Lagie</li>
                        </ul>
                    </div>
                </div>
            </div>
